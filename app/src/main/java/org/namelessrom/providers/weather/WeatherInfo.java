...
public class WeatherInfo {
    ...
    private static String getCondition(Context context, int conditionCode, String condition) {
        ...
        final int resId =
                res.getIdentifier("weather_" + conditionCode, "string", context.getPackageName());
        if (resId != 0) {
    ...
    public String getWindDirection() {
        ...
        if (windDirection < 0) { resId = R.string.unknown; } else if (windDirection < 23) {
        ...
        } else if (windDirection < 338) { resId = R.string.weather_NW; } else {
            resId = R.string.weather_N;
        }
    ...
    public static WeatherInfo fromSerializedString(Context context, String input) {
        ...
        try {
            ...
            forecastItems = forecastParts[0] == null ? 0 : Integer.parseInt(forecastParts[0]);
